...
// Plain bicycle states
enum
{
    BICYCLE_STATE_NORMAL,
    BICYCLE_STATE_TURNING,
    BICYCLE_STATE_BRAKED_ON_INCLINE,
};

// Plain bicycle transitions
enum
{
    BICYCLE_TRANS_FACE_DIRECTION,
    BICYCLE_TRANS_FACE_DIRECTION_ACCOUNT_FOR_METATILE,
    BICYCLE_TRANS_MOVING_FAST,
    BICYCLE_TRANS_LET_GRAVITY_TAKE_CONTROL,
    BICYCLE_TRANS_START_MOVING,
    BICYCLE_TRANS_WHEELIE_IDLE,
    BICYCLE_TRANS_WHEELIE_HOPPING_STANDING,
    BICYCLE_TRANS_WHEELIE_HOPPING_MOVING,
    BICYCLE_TRANS_SIDE_JUMP,
    BICYCLE_TRANS_TURN_JUMP,
    BICYCLE_TRANS_WHEELIE_MOVING,
    BICYCLE_TRANS_WHEELIE_RISING_MOVING,
    BICYCLE_TRANS_WHEELIE_LOWERING_MOVING,
};
