...
#define HEAL_LOCATION_NEW_BARK_TOWN_HIROS_HOUSE_2F 1
#define HEAL_LOCATION_NEW_BARK_TOWN_OTHER_HOUSE 2
...
#define HEAL_LOCATION_NEW_BARK_TOWN_1 12
#define HEAL_LOCATION_NEW_BARK_TOWN_2 13
