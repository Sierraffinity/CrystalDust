...
#define FLAG_PHONE_CARD_ROSE            0x15E
...
#define FLAG_HIDDEN_ITEM_ROUTE_32_SUPER_POTION              (FLAG_HIDDEN_ITEMS_START + 0x2C)
...
#define FLAG_HIDDEN_ITEM_DARK_CAVE_B2F_EVERSTONE_1        (FLAG_HIDDEN_ITEMS_START + 0x30)
#define FLAG_HIDDEN_ITEM_DARK_CAVE_B2F_EVERSTONE_2        (FLAG_HIDDEN_ITEMS_START + 0x31)
...
#define FLAG_HIDE_VIOLET_CITY_WALLYS_UNCLE                          0x33E
...
#define FLAG_GB_PLAYER_ENABLED                      (SYSTEM_FLAGS + 0x26)
...
#define FLAG_UNUSED_0x920                           (DAILY_FLAGS_START + 0x20)  // Unused Flag
...
#define FLAG_UNUSED_0x924                           (DAILY_FLAGS_START + 0x24)  // Unused Flag
