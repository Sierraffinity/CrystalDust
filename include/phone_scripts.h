#ifndef GUARD_PHONE_SCRIPTS_H
#define GUARD_PHONE_SCRIPTS_H
...
extern const u8 PhoneScript_Youngster_Joey[];
extern const u8 PhoneScript_BirdKeeper_Vance[];
extern const u8 PhoneScript_Hiker_Parry[];
extern const u8 PhoneScript_Picnicker_Erin[];
extern const u8 PhoneScript_Cooltrainer_Reena[];
extern const u8 PhoneScript_Cooltrainer_Gaven[];
extern const u8 PhoneScript_Cooltrainer_Beth[];
...
extern const u8 PhoneScript_Derek_BugCatching_Contest[];
extern const u8 PhoneScript_Gina[];
extern const u8 PhoneScript_Todd[];
