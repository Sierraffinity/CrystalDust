...
#define FLAG_BUENAS_PASSWORD FLAG_0x920
#define VAR_BUENAS_PASSWORD VAR_TEMP_0

#define MAPSEC_NEW_BARK_TOWN MAPSEC_LITTLEROOT_TOWN
#define MAPSEC_CHERRYGROVE_CITY MAPSEC_LITTLEROOT_TOWN
#define MAPSEC_AZALEA_TOWN MAPSEC_LITTLEROOT_TOWN
