...
bool8 MetatileBehavior_IsStaircaseUpEast(u8);
bool8 MetatileBehavior_IsStaircaseUpWest(u8);
bool8 MetatileBehavior_IsStaircaseDownEast(u8);
bool8 MetatileBehavior_IsStaircaseDownWest(u8);
bool8 MetatileBehavior_IsStaircase(u8);
...
bool8 MetatileBehavior_IsRegionMap(u8, u8);
...
bool8 MetatileBehavior_IsAncientPokemonReplica(u8);
bool8 MetatileBehavior_IsDistinguishedStatue(u8);
