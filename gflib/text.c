...
const struct FontInfo gFontInfos[] =
{
    ...
    { Font1Func, 0xA, 0x10, 0x1, 0x0, 0x0, 0x2, 0x1, 0x3 },
    ...
    { Font6Func, 0x10, 0x10, 0x0, 0x8, 0x0, 0x2, 0x1, 0x3 },
    ...
    if (gTextFlags.autoScroll == 0)
    {
        ...
        else
        {
            ...
            BlitBitmapRectToWindow(
                textPrinter->printerTemplate.windowId,
                arrowTiles,
                gDownArrowXCoords[*(u32*)subStruct << 17 >> 30], // subStruct->downArrowYPosIdx but again, stupidly retrieved
                0,
                0x80,
                0x10,
                textPrinter->printerTemplate.currentX,
    ...
    else
    {
        ...
        if (drawArrow == 0)
        {
            ...
            BlitBitmapRectToWindow(
                windowId,
                arrowTiles,
                gDownArrowXCoords[*yCoordIndex & 3],
                0,
                0x80,
                0x10,
                x,
