...
{
    { MAP_NUM(ROUTE110), MAP_NUM(ROUTE111), MAP_NUM(ROUTE45), MAP_NUM(ROUTE46), MAP_NUM(ROUTE134), 0xFF },
    { MAP_NUM(ROUTE111), MAP_NUM(ROUTE110), MAP_NUM(ROUTE45), MAP_NUM(ROUTE46), 0xFF, 0xFF },
    { MAP_NUM(ROUTE45), MAP_NUM(ROUTE111), MAP_NUM(ROUTE110), MAP_NUM(ROUTE46), 0xFF, 0xFF },
    { MAP_NUM(ROUTE46), MAP_NUM(ROUTE45), MAP_NUM(ROUTE110), MAP_NUM(ROUTE111), MAP_NUM(ROUTE119), MAP_NUM(ROUTE123) },
