...
static const u8 sPlayerAvatarGfxIds[][2] =
{
    ...
    {OBJ_EVENT_GFX_ZBRENDAN_SURFING,    OBJ_EVENT_GFX_ZMAY_SURFING},
...
static const u8 sPlayerAvatarGfxToStateFlag[2][5][2] =
{
    [MALE] =
    {
        ...
        {OBJ_EVENT_GFX_ZBRENDAN_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
    ...
    [FEMALE] =
    {
        ...
        {OBJ_EVENT_GFX_ZMAY_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
...
u8 GetPlayerAvatarGenderByGraphicsId(u8 gfxId)
{
    ...
    case OBJ_EVENT_GFX_ZMAY_SURFING:
