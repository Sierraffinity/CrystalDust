...
const struct PhoneContact gPhoneContacts[PHONE_CONTACT_COUNT] =
{
    ...
    [PHONE_CONTACT_BLACKBELT_KENJI] = {
        ...
        .rematchTrainerId = REMATCH_KENJI,
		.trainerId = TRAINER_NONE,
        .availability = PHONE_AVAILABILITY_ALWAYS,
        .isPermanent = FALSE,
    },
    ...
    [PHONE_CONTACT_JUGGLER_IRWIN] = {
        ...
        .rematchTrainerId = REMATCH_IRWIN,
		.trainerId = TRAINER_NONE,
        .availability = PHONE_AVAILABILITY_ALWAYS,
        .isPermanent = FALSE,
    },
    [PHONE_CONTACT_POKEFAN_DEREK] = {
        ...
        .rematchTrainerId = REMATCH_DEREK,
		.trainerId = TRAINER_NONE,
        .availability = PHONE_AVAILABILITY_ALWAYS,
        .isPermanent = FALSE,
    },
...
{
    int rematchTrainerId = phoneContact->trainerId;
    if(phoneContact->rematchTrainerId != 0xFF){
    	rematchTrainerId = gRematchTable[phoneContact->rematchTrainerId].trainerIds[0];
    }
