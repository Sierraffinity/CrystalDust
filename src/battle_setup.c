...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    //[REMATCH_BEVERLY] = REMATCH(TRAINER_BEVERLY, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, ROUTE32, PHONE_CONTACT_POKEFAN_BEVERLY),
    ...
    //[REMATCH_KENJI] = REMATCH(TRAINER_KENJI, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, ROUTE45, PHONE_CONTACT_BLACKBELT_KENJI),
    ...
    //[REMATCH_IRWIN] = REMATCH(TRAINER_IRWIN, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, ROUTE35, PHONE_CONTACT_JUGGLER_IRWIN),
    //[REMATCH_DEREK] = REMATCH(TRAINER_DEREK, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, TRAINER_NONE, ROUTE38, PHONE_CONTACT_POKEFAN_DEREK),
