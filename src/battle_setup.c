...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_DUSTY] = REMATCH(TRAINER_GINA, TRAINER_IRENE, TRAINER_JENN, TRAINER_KATE, TRAINER_CARRIE, ROUTE33, PHONE_CONTACT_DUSTY),
    [REMATCH_LOLA] = REMATCH(TRAINER_DONALD, TRAINER_BROOKE, TRAINER_KIM, TRAINER_BRYAN, TRAINER_WALT, ROUTE33, PHONE_CONTACT_LOLA),
    [REMATCH_RICKY] = REMATCH(TRAINER_ARNIE, TRAINER_JACK, TRAINER_BEVERLY, TRAINER_WILLIAM, TRAINER_KRISE, ROUTE33, PHONE_CONTACT_RICKY),
    [REMATCH_LILA_AND_ROY] = REMATCH(TRAINER_LILA_AND_ROY_1, TRAINER_LILA_AND_ROY_2, TRAINER_LILA_AND_ROY_3, TRAINER_LILA_AND_ROY_4, TRAINER_LILA_AND_ROY_5, ROUTE33, PHONE_CONTACT_LILA_AND_ROY),
    [REMATCH_CRISTIN] = REMATCH(TRAINER_CRISTIN_1, TRAINER_CRISTIN_2, TRAINER_CRISTIN_3, TRAINER_CRISTIN_4, TRAINER_CRISTIN_5, ROUTE33, PHONE_CONTACT_CRISTIN),
    [REMATCH_BROOKE] = REMATCH(TRAINER_VALERIE, TRAINER_EUGENE, TRAINER_JAIME, TRAINER_ALFRED, TRAINER_HUEY, ROUTE33, PHONE_CONTACT_BROOKE),
    [REMATCH_WILTON] = REMATCH(TRAINER_ALVARO, TRAINER_ALVARO, TRAINER_ALVARO, TRAINER_ALVARO, TRAINER_ALVARO, ROUTE33, PHONE_CONTACT_WILTON),
    [REMATCH_VALERIE] = REMATCH(TRAINER_CONNIE, TRAINER_DENIS, TRAINER_ERNEST, TRAINER_SIMON, TRAINER_ELAINE, ROUTE33, PHONE_CONTACT_VALERIE),
    [REMATCH_CINDY] = REMATCH(TRAINER_RANDALL, TRAINER_KIRK, TRAINER_BERKE, TRAINER_CHARLIE, TRAINER_SUSIE, ROUTE32, PHONE_CONTACT_CINDY),
    [REMATCH_THALIA] = REMATCH(TRAINER_RON, TRAINER_THALIA_2, TRAINER_THALIA_3, TRAINER_THALIA_4, TRAINER_THALIA_5, SPROUT_TOWER_3F, PHONE_CONTACT_THALIA),
    [REMATCH_JESSICA] = REMATCH(TRAINER_YOSHI, TRAINER_SHANE, TRAINER_BENJAMIN, TRAINER_MILLER, TRAINER_MARKUS, ROUTE33, PHONE_CONTACT_JESSICA),
    [REMATCH_WINSTON] = REMATCH(TRAINER_HUGH, TRAINER_GWEN, TRAINER_EMMA, TRAINER_SPENCER, TRAINER_TIFFANY, ROUTE33, PHONE_CONTACT_WINSTON),
    [REMATCH_STEVE] = REMATCH(TRAINER_MARVIN, TRAINER_AARON, TRAINER_RAYMOND, TRAINER_ANDRE, TRAINER_LOIS, ROUTE33, PHONE_CONTACT_STEVE),
    [REMATCH_TONY] = REMATCH(TRAINER_MAHOGANY_GRUNT_B2F_1, TRAINER_MARC, TRAINER_RADIO_TOWER_3F_GRUNT_2, TRAINER_RADIO_TOWER_3F_GRUNT_3, TRAINER_RADIO_TOWER_4F_GRUNT_M, ROUTE33, PHONE_CONTACT_TONY),
    [REMATCH_NOB] = REMATCH(TRAINER_RADIO_TOWER_5F_EXECUTIVE_F, TRAINER_RADIO_TOWER_5F_EXECUTIVE_2, TRAINER_UNDERGROUND_B2F_GRUNT_1, TRAINER_UNDERGROUND_B2F_GRUNT_2, TRAINER_UNDERGROUND_B2F_GRUNT_3, ROUTE33, PHONE_CONTACT_NOB),
    [REMATCH_KOJI] = REMATCH(TRAINER_KOJI_1, TRAINER_KOJI_2, TRAINER_KOJI_3, TRAINER_KOJI_4, TRAINER_KOJI_5, ROUTE33, PHONE_CONTACT_KOJI),
    [REMATCH_FERNANDO] = REMATCH(TRAINER_EDGAR, TRAINER_FERNANDO_2, TRAINER_FERNANDO_3, TRAINER_FERNANDO_4, TRAINER_FERNANDO_5, ROUTE33, PHONE_CONTACT_FERNANDO),
    [REMATCH_DALTON] = REMATCH(TRAINER_CYBIL, TRAINER_ALLEN, TRAINER_ZACH, TRAINER_WILTON, TRAINER_VANCE, ROUTE46, PHONE_CONTACT_DALTON),
    [REMATCH_BERNIE] = REMATCH(TRAINER_BERNIE_1, TRAINER_BERNIE_2, TRAINER_BERNIE_3, TRAINER_BERNIE_4, TRAINER_BERNIE_5, ROUTE33, PHONE_CONTACT_BERNIE),
    [REMATCH_ETHAN] = REMATCH(TRAINER_ETHAN_1, TRAINER_ETHAN_2, TRAINER_ETHAN_3, TRAINER_ETHAN_4, TRAINER_ETHAN_5, ROUTE33, PHONE_CONTACT_ETHAN),
    ...
    [REMATCH_JEFFREY] = REMATCH(TRAINER_JEFFREY_1, TRAINER_JEFFREY_2, TRAINER_JEFFREY_3, TRAINER_JEFFREY_4, TRAINER_JEFFREY_5, ROUTE33, PHONE_CONTACT_JEFFREY),
    [REMATCH_CAMERON] = REMATCH(TRAINER_CAMERON_1, TRAINER_CAMERON_2, TRAINER_CAMERON_3, TRAINER_CAMERON_4, TRAINER_CAMERON_5, ROUTE33, PHONE_CONTACT_CAMERON),
    [REMATCH_JACKI] = REMATCH(TRAINER_JACKI_1, TRAINER_JACKI_2, TRAINER_JACKI_3, TRAINER_JACKI_4, TRAINER_JACKI_5, ROUTE33, PHONE_CONTACT_JACKI),
    [REMATCH_WALTER] = REMATCH(TRAINER_WALTER_1, TRAINER_WALTER_2, TRAINER_WALTER_3, TRAINER_WALTER_4, TRAINER_WALTER_5, ROUTE33, PHONE_CONTACT_WALTER),
    [REMATCH_KAREN] = REMATCH(TRAINER_KAREN_1, TRAINER_KAREN_2, TRAINER_KAREN_3, TRAINER_KAREN_4, TRAINER_KAREN_5, ROUTE33, PHONE_CONTACT_KAREN),
    [REMATCH_JERRY] = REMATCH(TRAINER_JERRY_1, TRAINER_JERRY_2, TRAINER_JERRY_3, TRAINER_JERRY_4, TRAINER_JERRY_5, ROUTE33, PHONE_CONTACT_JERRY),
    ...
    [REMATCH_ISABEL] = REMATCH(TRAINER_ISABEL_1, TRAINER_ISABEL_2, TRAINER_ISABEL_3, TRAINER_ISABEL_4, TRAINER_ISABEL_5, ROUTE33, PHONE_CONTACT_ISABEL),
    ...
    [REMATCH_TIMOTHY] = REMATCH(TRAINER_TIMOTHY_1, TRAINER_TIMOTHY_2, TRAINER_TIMOTHY_3, TRAINER_TIMOTHY_4, TRAINER_TIMOTHY_5, ROUTE33, PHONE_CONTACT_TIMOTHY),
    ...
    [REMATCH_ISAIAH] = REMATCH(TRAINER_ISAIAH_1, TRAINER_ISAIAH_2, TRAINER_ISAIAH_3, TRAINER_ISAIAH_4, TRAINER_ISAIAH_5, ROUTE33, PHONE_CONTACT_ISAIAH),
    ...
    [REMATCH_ABIGAIL] = REMATCH(TRAINER_ABIGAIL_1, TRAINER_ABIGAIL_2, TRAINER_ABIGAIL_3, TRAINER_ABIGAIL_4, TRAINER_ABIGAIL_5, ROUTE33, PHONE_CONTACT_ABIGAIL),
    ...
    [REMATCH_KATELYN] = REMATCH(TRAINER_KATELYN_1, TRAINER_KATELYN_2, TRAINER_KATELYN_3, TRAINER_KATELYN_4, TRAINER_KATELYN_5, ROUTE33, PHONE_CONTACT_KATELYN),
    [REMATCH_BENJAMIN] = REMATCH(TRAINER_BENJAMIN_OLD_1, TRAINER_BENJAMIN_OLD_2, TRAINER_BENJAMIN_OLD_3, TRAINER_BENJAMIN_OLD_4, TRAINER_BENJAMIN_OLD_5, ROUTE33, PHONE_CONTACT_BENJAMIN),
    [REMATCH_PABLO] = REMATCH(TRAINER_PABLO_1, TRAINER_PABLO_2, TRAINER_PABLO_3, TRAINER_PABLO_4, TRAINER_PABLO_5, ROUTE33, PHONE_CONTACT_PABLO),
    ...
    [REMATCH_ROBERT] = REMATCH(TRAINER_ROBERT_1, TRAINER_ROBERT_2, TRAINER_ROBERT_3, TRAINER_ROBERT_4, TRAINER_ROBERT_5, ROUTE33, PHONE_CONTACT_ROBERT),
    [REMATCH_LAO] = REMATCH(TRAINER_LAO_OLD_1, TRAINER_LAO_OLD_2, TRAINER_LAO_OLD_3, TRAINER_LAO_OLD_4, TRAINER_LAO_OLD_5, ROUTE33, PHONE_CONTACT_LAO),
    [REMATCH_CYNDY] = REMATCH(TRAINER_CYNDY_1, TRAINER_CYNDY_2, TRAINER_CYNDY_3, TRAINER_CYNDY_4, TRAINER_CYNDY_5, ROUTE33, PHONE_CONTACT_CYNDY),
    [REMATCH_MADELINE] = REMATCH(TRAINER_MADELINE_1, TRAINER_MADELINE_2, TRAINER_MADELINE_3, TRAINER_MADELINE_4, TRAINER_MADELINE_5, ROUTE33, PHONE_CONTACT_MADELINE),
    [REMATCH_JENNY] = REMATCH(TRAINER_JENNY_1, TRAINER_JENNY_2, TRAINER_JENNY_3, TRAINER_JENNY_4, TRAINER_JENNY_5, ROUTE33, PHONE_CONTACT_JENNY),
    [REMATCH_DIANA] = REMATCH(TRAINER_DIANA_1, TRAINER_DIANA_2, TRAINER_DIANA_3, TRAINER_DIANA_4, TRAINER_DIANA_5, ROUTE33, PHONE_CONTACT_DIANA),
    ...
    [REMATCH_ERNEST] = REMATCH(TRAINER_ERNEST_OLD_1, TRAINER_ERNEST_OLD_2, TRAINER_ERNEST_OLD_3, TRAINER_ERNEST_OLD_4, TRAINER_ERNEST_OLD_5, ROUTE33, PHONE_CONTACT_ERNEST),
    ...
    [REMATCH_EDWIN] = REMATCH(TRAINER_EDWIN_1, TRAINER_EDWIN_2, TRAINER_EDWIN_3, TRAINER_EDWIN_4, TRAINER_EDWIN_5, ROUTE33, PHONE_CONTACT_EDWIN),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_TROY, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, ROUTE33, PHONE_CONTACT_GABRIELLE),
    [REMATCH_CATHERINE] = REMATCH(TRAINER_CATHERINE_1, TRAINER_CATHERINE_2, TRAINER_CATHERINE_3, TRAINER_CATHERINE_4, TRAINER_CATHERINE_5, ROUTE33, PHONE_CONTACT_CATHERINE),
    [REMATCH_JACKSON] = REMATCH(TRAINER_JACKSON_1, TRAINER_JACKSON_2, TRAINER_JACKSON_3, TRAINER_JACKSON_4, TRAINER_JACKSON_5, ROUTE33, PHONE_CONTACT_JACKSON),
    ...
    [REMATCH_TRENT] = REMATCH(TRAINER_TRENT_1, TRAINER_TRENT_2, TRAINER_TRENT_3, TRAINER_TRENT_4, TRAINER_TRENT_5, ROUTE33, PHONE_CONTACT_TRENT),
    ...
    [REMATCH_WALLY_3] = REMATCH(TRAINER_WALLY_VR_2, TRAINER_WALLY_VR_3, TRAINER_WALLY_VR_4, TRAINER_WALLY_VR_5, TRAINER_WALLY_VR_5, SLOWPOKE_WELL_B1F, PHONE_CONTACT_WALLY),
    [REMATCH_ROXANNE] = REMATCH(TRAINER_FALKNER, TRAINER_ROXANNE_OLD_2, TRAINER_ROXANNE_OLD_3, TRAINER_ROXANNE_OLD_4, TRAINER_ROXANNE_OLD_5, GOLDENROD_CITY, PHONE_CONTACT_ROXANNE),
    ...
    [REMATCH_WATTSON] = REMATCH(TRAINER_WHITNEY, TRAINER_WATTSON_2, TRAINER_WATTSON_3, TRAINER_WATTSON_4, TRAINER_WATTSON_5, ROUTE33, PHONE_CONTACT_WATTSON),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_MORTY, TRAINER_FLANNERY_2, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, TRAINER_FLANNERY_5, ROUTE33, PHONE_CONTACT_FLANNERY),
    [REMATCH_NORMAN] = REMATCH(TRAINER_CHUCK, TRAINER_NORMAN_OLD_2, TRAINER_NORMAN_OLD_3, TRAINER_NORMAN_OLD_4, TRAINER_NORMAN_OLD_5, VIOLET_CITY, PHONE_CONTACT_NORMAN),
    [REMATCH_WINONA] = REMATCH(TRAINER_JASMINE, TRAINER_WINONA_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_5, ROUTE33, PHONE_CONTACT_WINONA),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_PRYCE, TRAINER_TATE_AND_LIZA_2, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_5, ROUTE33, PHONE_CONTACT_TATE_AND_LIZA),
    [REMATCH_JUAN] = REMATCH(TRAINER_JUAN_1, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_5, ROUTE33, PHONE_CONTACT_JUAN),
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, TRAINER_SIDNEY, ROUTE33, PHONE_CONTACT_SIDNEY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, TRAINER_PHOEBE, ROUTE33, PHONE_CONTACT_PHOEBE),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, TRAINER_GLACIA, ROUTE33, PHONE_CONTACT_GLACIA),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, TRAINER_DRAKE, ROUTE33, PHONE_CONTACT_DRAKE),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, ROUTE33, PHONE_CONTACT_WALLACE),
};
