...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_BERNIE] = REMATCH(TRAINER_DARIN, TRAINER_CARA, TRAINER_LEA_AND_PIA, TRAINER_ERIK, TRAINER_RYAN, ROUTE33, PHONE_CONTACT_BERNIE),
    [REMATCH_ETHAN] = REMATCH(TRAINER_QUENTIN, TRAINER_ETHAN_2, TRAINER_ETHAN_3, TRAINER_ETHAN_4, TRAINER_ETHAN_5, ROUTE33, PHONE_CONTACT_ETHAN),
    ...
    [REMATCH_JUAN] = REMATCH(TRAINER_CLAIR, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_5, ROUTE33, PHONE_CONTACT_JUAN),
