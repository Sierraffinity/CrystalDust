...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ETHAN] = REMATCH(TRAINER_QUENTIN, TRAINER_JOSE, TRAINER_BRIAN, TRAINER_GILBERT, TRAINER_REENA, ROUTE33, PHONE_CONTACT_ETHAN),
    ...
    [REMATCH_JEFFREY] = REMATCH(TRAINER_GAVEN, TRAINER_GAVEN, TRAINER_JEFFREY_3, TRAINER_JEFFREY_4, TRAINER_JEFFREY_5, ROUTE33, PHONE_CONTACT_JEFFREY),
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_WILL, TRAINER_WILL, TRAINER_WILL, TRAINER_WILL, TRAINER_WILL, ROUTE33, PHONE_CONTACT_SIDNEY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_KOGA, TRAINER_KOGA, TRAINER_KOGA, TRAINER_KOGA, TRAINER_KOGA, ROUTE33, PHONE_CONTACT_PHOEBE),
    [REMATCH_GLACIA] = REMATCH(TRAINER_BRUNO, TRAINER_BRUNO, TRAINER_BRUNO, TRAINER_BRUNO, TRAINER_BRUNO, ROUTE33, PHONE_CONTACT_GLACIA),
    [REMATCH_DRAKE] = REMATCH(TRAINER_KAREN, TRAINER_KAREN, TRAINER_KAREN, TRAINER_KAREN, TRAINER_KAREN, ROUTE33, PHONE_CONTACT_DRAKE),
    [REMATCH_WALLACE] = REMATCH(TRAINER_LANCE, TRAINER_LANCE, TRAINER_LANCE, TRAINER_LANCE, TRAINER_LANCE, ROUTE33, PHONE_CONTACT_WALLACE),
};
