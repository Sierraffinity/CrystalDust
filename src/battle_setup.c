...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_BROOKE] = REMATCH(TRAINER_VALERIE, TRAINER_EUGENE, TRAINER_JAIME, TRAINER_ALFRED, TRAINER_HUEY, ROUTE111, PHONE_CONTACT_BROOKE),
    [REMATCH_WILTON] = REMATCH(TRAINER_ALVARO, TRAINER_ALVARO, TRAINER_ALVARO, TRAINER_ALVARO, TRAINER_ALVARO, ROUTE111, PHONE_CONTACT_WILTON),
    [REMATCH_VALERIE] = REMATCH(TRAINER_CONNIE, TRAINER_DENIS, TRAINER_ERNEST, TRAINER_SIMON, TRAINER_ELAINE, MT_PYRE_6F, PHONE_CONTACT_VALERIE),
    ...
    [REMATCH_JESSICA] = REMATCH(TRAINER_YOSHI, TRAINER_SHANE, TRAINER_BENJAMIN, TRAINER_MILLER, TRAINER_MARKUS, ROUTE121, PHONE_CONTACT_JESSICA),
    [REMATCH_WINSTON] = REMATCH(TRAINER_HUGH, TRAINER_GWEN, TRAINER_EMMA, TRAINER_SPENCER, TRAINER_TIFFANY, ROUTE32, PHONE_CONTACT_WINSTON),
    [REMATCH_STEVE] = REMATCH(TRAINER_MARVIN, TRAINER_AARON, TRAINER_RAYMOND, TRAINER_ANDRE, TRAINER_LOIS, ROUTE114, PHONE_CONTACT_STEVE),
    [REMATCH_TONY] = REMATCH(TRAINER_MAHOGANY_GRUNT_B2F_1, TRAINER_TONY_2, TRAINER_TONY_3, TRAINER_TONY_4, TRAINER_TONY_5, ROUTE35, PHONE_CONTACT_TONY),
    [REMATCH_NOB] = REMATCH(TRAINER_NOB_OLD_1, TRAINER_NOB_OLD_2, TRAINER_NOB_OLD_3, TRAINER_NOB_OLD_4, TRAINER_NOB_OLD_5, ROUTE115, PHONE_CONTACT_NOB),
    ...
    [REMATCH_BENJAMIN] = REMATCH(TRAINER_BENJAMIN_OLD_1, TRAINER_BENJAMIN_OLD_2, TRAINER_BENJAMIN_OLD_3, TRAINER_BENJAMIN_OLD_4, TRAINER_BENJAMIN_OLD_5, ROUTE110, PHONE_CONTACT_BENJAMIN),
    ...
    [REMATCH_LAO] = REMATCH(TRAINER_LAO_OLD_1, TRAINER_LAO_OLD_2, TRAINER_LAO_OLD_3, TRAINER_LAO_OLD_4, TRAINER_LAO_OLD_5, ROUTE113, PHONE_CONTACT_LAO),
    ...
    [REMATCH_ERNEST] = REMATCH(TRAINER_ERNEST_OLD_1, TRAINER_ERNEST_OLD_2, TRAINER_ERNEST_OLD_3, TRAINER_ERNEST_OLD_4, TRAINER_ERNEST_OLD_5, ROUTE125, PHONE_CONTACT_ERNEST),
    ...
    [REMATCH_FLANNERY] = REMATCH(TRAINER_MORTY, TRAINER_FLANNERY_2, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, TRAINER_FLANNERY_5, LAVARIDGE_TOWN, PHONE_CONTACT_FLANNERY),
    ...
    [REMATCH_WINONA] = REMATCH(TRAINER_JASMINE, TRAINER_WINONA_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_5, FORTREE_CITY, PHONE_CONTACT_WINONA),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_PRYCE, TRAINER_TATE_AND_LIZA_2, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_5, MOSSDEEP_CITY, PHONE_CONTACT_TATE_AND_LIZA),
