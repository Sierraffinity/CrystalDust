...
{
    [REMATCH_ROSE] = REMATCH(TRAINER_AMY_AND_MAY, TRAINER_JOSH, TRAINER_TODD, TRAINER_SAMUEL, TRAINER_IAN, ROUTE46, PHONE_CONTACT_ROSE),
    ...
    [REMATCH_DUSTY] = REMATCH(TRAINER_GINA, TRAINER_IRENE, TRAINER_JENN, TRAINER_KATE, TRAINER_DUSTY_5, ROUTE111, PHONE_CONTACT_DUSTY),
    ...
    [REMATCH_ELLIOT] = REMATCH(TRAINER_ELLIOT_1, TRAINER_ELLIOT_2, TRAINER_ELLIOT_3, TRAINER_ELLIOT_4, TRAINER_ELLIOT_5, ROUTE34, PHONE_CONTACT_ELLIOT),
