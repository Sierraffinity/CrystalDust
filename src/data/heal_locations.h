...
{
    {MAP_GROUP(NEW_BARK_TOWN_HIROS_HOUSE_2F), MAP_NUM(NEW_BARK_TOWN_HIROS_HOUSE_2F), 4, 2},
    {MAP_GROUP(NEW_BARK_TOWN_OTHER_HOUSE), MAP_NUM(NEW_BARK_TOWN_OTHER_HOUSE), 4, 2},
    ...
    {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), 16, 8},
    {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), 14, 9},
    {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 48, 6},
