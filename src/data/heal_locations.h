static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(VIOLET_CITY), MAP_NUM(VIOLET_CITY), 38, 29},
    {MAP_GROUP(ROUTE32), MAP_NUM(ROUTE32), 17, 100},
    ...
    {MAP_GROUP(CHERRYGROVE_CITY), MAP_NUM(CHERRYGROVE_CITY), 42, 6},
    {MAP_GROUP(AZALEA_TOWN), MAP_NUM(AZALEA_TOWN), 26, 10},
