...
const struct SpriteTemplate gFieldEffectObjectTemplate_Arrow = {0xFFFF, 0x1006, &gObjectEventBaseOam_16x16, gFieldEffectObjectImageAnimTable_Arrow, gFieldEffectObjectPicTable_Arrow, gDummySpriteAffineAnimTable, SpriteCallbackDummy};
...
const struct SpritePalette gFieldEffectObjectPaletteInfo11 = {gObjectEventPalette28, 0x1006};
