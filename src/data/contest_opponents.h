...
const struct ContestPokemon gContestOpponents[] =
{
    ...
    [CONTEST_OPPONENT_KELSEY] = {
        ...
        .trainerGfxId = OBJ_EVENT_GFX_WOMAN,
    ...
    [CONTEST_OPPONENT_MADISON] = {
        ...
        .trainerGfxId = OBJ_EVENT_GFX_ZPOKEFAN_F,
    ...
    [CONTEST_OPPONENT_MARIAH] = {
        ...
        .trainerGfxId = OBJ_EVENT_GFX_GIRL,
    ...
    [CONTEST_OPPONENT_CHANCE] = {
        ...
        .trainerGfxId = OBJ_EVENT_GFX_ZRICH_BOY,
    ...
    [CONTEST_OPPONENT_COLBY] = {
        ...
        .nickname = _("TOTDIL"),
        .trainerName = _("COLBY"),
        .trainerGfxId = OBJ_EVENT_GFX_ZNINJA_BOY,
        .aiFlags = CONTEST_AI_SET_6,
        .whichRank = CONTEST_RANK_NORMAL,
        .aiPool_Cool = TRUE,
        .aiPool_Beauty = TRUE,
    ...
    [CONTEST_OPPONENT_KYLIE] = {
        ...
        .nickname = _("BALEDY"),
        .trainerName = _("KYLIE"),
        .trainerGfxId = OBJ_EVENT_GFX_BUENA,
        .aiFlags = CONTEST_AI_SET_7,
        .whichRank = CONTEST_RANK_NORMAL,
        .aiPool_Cool = TRUE,
        .aiPool_Beauty = FALSE,
    ...
    [CONTEST_OPPONENT_MILO] = {
        ...
        .nickname = _("TARVITAR"),
        .trainerName = _("MILO"),
        .trainerGfxId = OBJ_EVENT_GFX_POKEMANIAC,
        .aiFlags = CONTEST_AI_SET_9,
        .whichRank = CONTEST_RANK_NORMAL,
        .aiPool_Cool = FALSE,
        .aiPool_Beauty = FALSE,
    ...
    [CONTEST_OPPONENT_BOBBY] = {
        ...
        .nickname = _("DUODO"),
        .trainerName = _("BOBBY"),
        .trainerGfxId = OBJ_EVENT_GFX_ZRUNNING_TRIATHLETE_M,
        .aiFlags = CONTEST_AI_SET_2,
        .whichRank = CONTEST_RANK_SUPER,
        .aiPool_Cool = TRUE,
        .aiPool_Beauty = TRUE,
    ...
    [CONTEST_OPPONENT_DIEGO] = {
        ...
        .nickname = _("HITEMON"),
        .trainerName = _("DIEGO"),
        .trainerGfxId = OBJ_EVENT_GFX_MR_POKEMON,
        .aiFlags = CONTEST_AI_SET_5,
        .whichRank = CONTEST_RANK_SUPER,
        .aiPool_Cool = TRUE,
        .aiPool_Beauty = FALSE,
    ...
    [CONTEST_OPPONENT_SELENA] = {
        ...
        .trainerGfxId = OBJ_EVENT_GFX_PROF_OAK,
        .aiFlags = CONTEST_AI_SET_19,
        .whichRank = CONTEST_RANK_HYPER,
        .aiPool_Cool = FALSE,
        .aiPool_Beauty = TRUE,
    ...
    [CONTEST_OPPONENT_DEVON] = {
        ...
        .nickname = _("MILKAN"),
        .trainerName = _("DEVON"),
        .trainerGfxId = OBJ_EVENT_GFX_SAGE,
        .aiFlags = CONTEST_AI_SET_9,
        .whichRank = CONTEST_RANK_HYPER,
        .aiPool_Cool = FALSE,
        .aiPool_Beauty = TRUE,
