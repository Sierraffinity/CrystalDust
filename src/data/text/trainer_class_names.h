const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_MYSTICALMAN] = _("MYSTICALMAN"),
    ...
    [TRAINER_CLASS_TEACHER] = _("TEACHER"),
    [TRAINER_CLASS_BIKER] = _("BIKER"),
    [TRAINER_CLASS_RIVAL2] = _("RIVAL"),
    [TRAINER_CLASS_TEAM_ROCKET_EXECUTIVE] = _("TEAM ROCKET"),
};
