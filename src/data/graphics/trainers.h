...
const u32 gTrainerFrontPic_Officer[] = INCBIN_U32("graphics/trainers/front_pics/interviewer_front_pic.4bpp.lz");
const u32 gTrainerPalette_Officer[] = INCBIN_U32("graphics/trainers/palettes/interviewer.gbapal.lz");
