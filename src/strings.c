...
const u8 gText_FreshWaterAndPrice[] = _("FRESH WATER{CLEAR_TO 0x57}{SMALL}¥200");
const u8 gText_SodaPopAndPrice[] = _("SODA POP{CLEAR_TO 0x57}{SMALL}¥300");
const u8 gText_LemonadeAndPrice[] = _("LEMONADE{CLEAR_TO 0x57}{SMALL}¥350");
...
const u8 gText_AbraPrizeAndPrice[] = _("ABRA{CLEAR_TO 0x55}{SMALL} 100 COINS");
const u8 gText_CubonePrizeAndPrice[] = _("CUBONE{CLEAR_TO 0x55}{SMALL} 800 COINS");
const u8 gText_WobbuffetPrizeAndPrice[] = _("WOBBUFFET{CLEAR_TO 0x4B}{SMALL} 1,500 COINS");
const u8 gText_50CoinsAndPrice[] = _("{SMALL} 50 COINS{CLEAR_TO 0x45}¥1,000");
const u8 gText_500CoinsAndPrice[] = _("{SMALL}500 COINS{CLEAR_TO 0x40}¥10,000");
...
const u8 gText_TM25AndPrice[] = _("TM25{CLEAR_TO 0x48}{SMALL}5,500 COINS");
const u8 gText_TM14AndPrice[] = _("TM14{CLEAR_TO 0x48}{SMALL}5,500 COINS");
const u8 gText_TM38AndPrice[] = _("TM38{CLEAR_TO 0x48}{SMALL}5,500 COINS");
...
const u8 gText_UltraBall2Points[] = _("ULTRA BALL {CLEAR_TO 96}{SMALL}2 POINTS");
const u8 gText_FullRestore2Points[] = _("FULL RESTORE {CLEAR_TO 96}{SMALL}2 POINTS");
const u8 gText_Nugget3Points[] = _("NUGGET {CLEAR_TO 96}{SMALL}3 POINTS");
const u8 gText_RareCandy3Points[] = _("RARE CANDY {CLEAR_TO 96}{SMALL}3 POINTS");
const u8 gText_Protein5Points[] = _("PROTEIN {CLEAR_TO 96}{SMALL}5 POINTS");
const u8 gText_Iron5Points[] = _("IRON {CLEAR_TO 96}{SMALL}5 POINTS");
const u8 gText_Carbos5Points[] = _("CARBOS {CLEAR_TO 96}{SMALL}5 POINTS");
const u8 gText_Calcium5Points[] = _("CALCIUM {CLEAR_TO 96}{SMALL}5 POINTS");
const u8 gText_HPUp5Points[] = _("HP UP {CLEAR_TO 96}{SMALL}5 POINTS");
...
const u8 gText_MenuQuit[] = _("QUIT");
