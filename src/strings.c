...
const u8 gText_DefaultNameArianna[] = _("ARIANNA");
...
const u8 gText_TextSpeedSlow[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}SLOW");
const u8 gText_TextSpeedMid[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}MID");
const u8 gText_TextSpeedFast[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}FAST");
const u8 gText_BattleSceneOn[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}ON");
const u8 gText_BattleSceneOff[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}OFF");
const u8 gText_BattleStyleShift[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}SHIFT");
const u8 gText_BattleStyleSet[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}SET");
const u8 gText_SoundMono[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}MONO");
const u8 gText_SoundStereo[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}STEREO");
const u8 gText_FrameType[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}TYPE");
const u8 gText_FrameTypeNumber[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}");
const u8 gText_ButtonTypeNormal[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}NORMAL");
const u8 gText_ButtonTypeLR[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}LR");
const u8 gText_ButtonTypeLEqualsA[] = _("{COLOR DARK_GREY}{SHADOW LIGHT_GREY}L=A");
