...
const u8 gText_NumberVar1Clear7Var2[] = _("{FONT SMALL}{NO}{CLEAR 1}{STR_VAR_1} {FONT NORMAL}{STR_VAR_2}");
const u8 gText_ClearTo11Var1Clear5Var2[] = _("{FONT SMALL}{CLEAR_TO 18}{NO}{CLEAR 1}{STR_VAR_1} {FONT NORMAL}{STR_VAR_2}");
...
const u8 gText_TM24AndPrice[] = _("TM24{CLEAR_TO 0x48}{FONT SMALL}5,500 COINS");
const u8 gText_TM13AndPrice[] = _("TM13{CLEAR_TO 0x48}{FONT SMALL}5,500 COINS");
const u8 gText_TM35AndPrice[] = _("TM35{CLEAR_TO 0x48}{FONT SMALL}5,500 COINS");
