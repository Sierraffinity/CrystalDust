...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_BATTLE_GIRL, TRAINER_ENCOUNTER_MUSIC_SAGE},
    ...
    {TRAINER_CLASS_COOLTRAINER, TRAINER_ENCOUNTER_MUSIC_OFFICER},
    ...
    {TRAINER_CLASS_OFFICER, TRAINER_ENCOUNTER_MUSIC_KIMONO},
    {TRAINER_CLASS_RUIN_MANIAC, TRAINER_ENCOUNTER_MUSIC_FISHERMAN},
    ...
    {TRAINER_CLASS_BLACK_BELT, TRAINER_ENCOUNTER_MUSIC_SAGE},
    ...
    {TRAINER_CLASS_KINDLER, TRAINER_ENCOUNTER_MUSIC_FISHERMAN},
    {TRAINER_CLASS_SUPER_NERD, TRAINER_ENCOUNTER_MUSIC_MAGMA},
    ...
    {TRAINER_CLASS_PICNICKER, TRAINER_ENCOUNTER_MUSIC_LASS},
    {TRAINER_CLASS_JUGGLER, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    {TRAINER_CLASS_SAGE, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {TRAINER_CLASS_PKMN_RANGER, TRAINER_ENCOUNTER_MUSIC_OFFICER},
    {TRAINER_CLASS_PKMN_TRAINER_3, TRAINER_ENCOUNTER_MUSIC_MALE},
    {TRAINER_CLASS_YOUNG_COUPLE, TRAINER_ENCOUNTER_MUSIC_LASS},
    ...
    {TRAINER_CLASS_BIRD_KEEPER, TRAINER_ENCOUNTER_MUSIC_OFFICER},
    {TRAINER_CLASS_FISHERMAN, TRAINER_ENCOUNTER_MUSIC_FISHERMAN},
    {TRAINER_CLASS_CHAMPION, TRAINER_ENCOUNTER_MUSIC_MALE},
    {TRAINER_CLASS_TUBER_M, TRAINER_ENCOUNTER_MUSIC_MALE},
    {TRAINER_CLASS_TUBER_F, TRAINER_ENCOUNTER_MUSIC_LASS},
    {TRAINER_CLASS_SIS_AND_BRO, TRAINER_ENCOUNTER_MUSIC_SWIMMER},
    {TRAINER_CLASS_HIKER, TRAINER_ENCOUNTER_MUSIC_FISHERMAN},
...
void PrintOnTrainerHillRecordsWindow(void)
{
    ...
    for (i = 0; i < 4; i++)
    {
        AddTextPrinterParameterized3(0, 2, 0, y, sRecordWinColors, TEXT_SPEED_FF, sTagMatchStrings[i]);
        y += 15;
