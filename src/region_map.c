...
static const u8 sMapHealLocations[][3] = {
    ...
    {MAP_GROUP(CIANWOOD_CITY), MAP_NUM(CIANWOOD_CITY), HEAL_LOCATION_CIANWOOD_CITY},
    {MAP_GROUP(MAHOGANY_TOWN), MAP_NUM(MAHOGANY_TOWN), HEAL_LOCATION_MAHOGANY_TOWN},
    {MAP_GROUP(NONE), MAP_NUM(NONE), 0},
    {MAP_GROUP(NONE), MAP_NUM(NONE), 0},
    {MAP_GROUP(VIOLET_CITY), MAP_NUM(VIOLET_CITY), HEAL_LOCATION_VIOLET_CITY},
    {MAP_GROUP(ECRUTEAK_CITY), MAP_NUM(ECRUTEAK_CITY), HEAL_LOCATION_ECRUTEAK_CITY},
    {MAP_GROUP(OLIVINE_CITY), MAP_NUM(OLIVINE_CITY), HEAL_LOCATION_OLIVINE_CITY},
    {MAP_GROUP(GOLDENROD_CITY), MAP_NUM(GOLDENROD_CITY), HEAL_LOCATION_GOLDENROD_CITY},
    {MAP_GROUP(NONE), MAP_NUM(NONE), 0},
    {MAP_GROUP(BLACKTHORN_CITY), MAP_NUM(BLACKTHORN_CITY), HEAL_LOCATION_BLACKTHORN_CITY},
    {MAP_GROUP(NONE), MAP_NUM(NONE), 0},
    {MAP_GROUP(NONE), MAP_NUM(NONE), 0},
    {MAP_GROUP(ROUTE23), MAP_NUM(ROUTE23), HEAL_LOCATION_ROUTE23},
    ...
    {MAP_GROUP(ROUTE37), MAP_NUM(ROUTE37), 0},
    {MAP_GROUP(ROUTE38), MAP_NUM(ROUTE38), 0},
    {MAP_GROUP(ROUTE39), MAP_NUM(ROUTE39), 0},
    {MAP_GROUP(ROUTE40), MAP_NUM(ROUTE40), 0},
    {MAP_GROUP(ROUTE41), MAP_NUM(ROUTE41), 0},
    {MAP_GROUP(ROUTE42), MAP_NUM(ROUTE42), 0},
    {MAP_GROUP(ROUTE43), MAP_NUM(ROUTE43), 0},
    {MAP_GROUP(ROUTE44), MAP_NUM(ROUTE44), 0},
    {MAP_GROUP(ROUTE45), MAP_NUM(ROUTE45), 0},
    {MAP_GROUP(ROUTE46), MAP_NUM(ROUTE46), 0},
    {MAP_GROUP(ROUTE26), MAP_NUM(ROUTE26), 0},
    {MAP_GROUP(ROUTE27), MAP_NUM(ROUTE27), 0},
    {MAP_GROUP(ROUTE28), MAP_NUM(ROUTE28), 0},
