...
const u16 sTitleScreenCloudsTilemap[] = INCBIN_U16("graphics/title_screen/press_start.bin.lz");
...
const u16 gTitleScreenPokemonLogoTilemap[] = INCBIN_U16("graphics/title_screen/title_screen2.bin.lz");
