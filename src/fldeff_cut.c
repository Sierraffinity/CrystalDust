...
static void SetCutGrassMetatile(s16 x, s16 y)
{
    ...
    case METATILE_General_TallGrass_TreeUp:
        ...
        break;
    case METATILE_NewBark_TallGrass_NewBarkTreeLeft:
        MapGridSetMetatileIdAt(x, y, METATILE_NewBark_Grass_NewBarkTreeLeft);
        break;
    case METATILE_NewBark_TallGrass_NewBarkTreeRight:
        MapGridSetMetatileIdAt(x, y, METATILE_NewBark_Grass_NewBarkTreeRight);
        break;
    }
}
