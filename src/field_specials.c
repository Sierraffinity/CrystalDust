...
static u8 GetTextColorFromGraphicsId(u16 graphicsId)
{
    const u8 textColors[NUM_OBJ_EVENT_GFX] = {
        ...
        [OBJ_EVENT_GFX_ZBRENDAN_SURFING] =           MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_GOLD_FIELD_MOVE] =           MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZQUINTY_PLUMP] =              MSG_COLOR_BLUE,
        ...
        [OBJ_EVENT_GFX_ZPOKEFAN_F] =                 MSG_COLOR_RED,
        ...
        [OBJ_EVENT_GFX_ZRAYQUAZA_STILL] =            MSG_COLOR_BLACK,
        ...
        [OBJ_EVENT_GFX_ZRUNNING_TRIATHLETE_M] =      MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZRUNNING_TRIATHLETE_F] =      MSG_COLOR_RED,
        ...
        [OBJ_EVENT_GFX_ZUNUSED_NATU_DOLL] =          MSG_COLOR_SYS,
        [OBJ_EVENT_GFX_ZUNUSED_MAGNEMITE_DOLL] =     MSG_COLOR_SYS,
        [OBJ_EVENT_GFX_SQUIRTLE_DOLL] =      MSG_COLOR_SYS,
        [OBJ_EVENT_GFX_ZUNUSED_WOOPER_DOLL] =        MSG_COLOR_SYS,
        [OBJ_EVENT_GFX_ZUNUSED_PIKACHU_DOLL] =       MSG_COLOR_SYS,
        ...
        [OBJ_EVENT_GFX_ZROOFTOP_SALE_WOMAN] =        MSG_COLOR_RED,
        ...
        [OBJ_EVENT_GFX_ZMOVING_BOX] =                MSG_COLOR_SYS,
        [OBJ_EVENT_GFX_ZCABLE_CAR] =                 MSG_COLOR_SYS,
        ...
        [OBJ_EVENT_GFX_ZMAGMA_MEMBER_M] =            MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZMAGMA_MEMBER_F] =            MSG_COLOR_RED,
        [OBJ_EVENT_GFX_ZSIDNEY] =                    MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZPHOEBE] =                    MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZGLACIA] =                    MSG_COLOR_RED,
        [OBJ_EVENT_GFX_ZDRAKE] =                     MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_FALKNER] =                   MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_BUGSY] =                     MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_WHITNEY] =                   MSG_COLOR_RED,
        [OBJ_EVENT_GFX_ZFLANNERY] =                  MSG_COLOR_RED,
        [OBJ_EVENT_GFX_ZNORMAN] =                    MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZWINONA] =                    MSG_COLOR_RED,
        [OBJ_EVENT_GFX_ZLIZA] =                      MSG_COLOR_RED,
        [OBJ_EVENT_GFX_ZTATE] =                      MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZWALLACE] =                   MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZSTEVEN] =                    MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_RIVAL] =                     MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZLITTLE_BOY_3] =              MSG_COLOR_BLUE,
        ...
        [OBJ_EVENT_GFX_ZARCHIE] =                    MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZMAXIE] =                     MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZKYOGRE_FRONT] =              MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_ZGROUDON_FRONT] =             MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_ZFOSSIL] =                    MSG_COLOR_SYS,
        [OBJ_EVENT_GFX_ZREGIROCK] =                  MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_ZREGICE] =                    MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_ZREGISTEEL] =                 MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_PIDGEY] =                    MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_RATTATA] =                   MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_ZKYOGRE_ASLEEP] =             MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_ZGROUDON_ASLEEP] =            MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_ZRAYQUAZA] =                  MSG_COLOR_BLACK,
        ...
        [OBJ_EVENT_GFX_ZJUAN] =                      MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZSCOTT] =                     MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_MARILL] =                    MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_ZKYOGRE_SIDE] =               MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_ZGROUDON_SIDE] =              MSG_COLOR_BLACK,
        [OBJ_EVENT_GFX_MYSTERY_GIFT_MAN] =          MSG_COLOR_BLUE,
        [OBJ_EVENT_GFX_ZTRICK_HOUSE_STATUE] =        MSG_COLOR_SYS,
