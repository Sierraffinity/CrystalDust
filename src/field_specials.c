...
static u8 GetTextColorFromGraphicsId(u16 graphicsId)
{
    const u8 textColors[] = {
        ...
        [EVENT_OBJ_GFX_EXPERT_M] =                  MSG_COLOR_BLUE,
        [EVENT_OBJ_GFX_EXPERT_F] =                  MSG_COLOR_RED,
        [EVENT_OBJ_GFX_MAN_2] =                     MSG_COLOR_BLUE,
        [EVENT_OBJ_GFX_WOMAN_3] =                   MSG_COLOR_RED,
        [EVENT_OBJ_GFX_POKEFAN_M] =                 MSG_COLOR_BLUE,
        ...
        [EVENT_OBJ_GFX_SCIENTIST_1] =               MSG_COLOR_BLUE,
        ...
        [EVENT_OBJ_GFX_PROF_BIRCH] =                MSG_COLOR_BLUE,
        ...
        [EVENT_OBJ_GFX_SCIENTIST_2] =               MSG_COLOR_BLUE,
        ...
        [EVENT_OBJ_GFX_SKITTY] =                    MSG_COLOR_BLACK,
        [EVENT_OBJ_GFX_KECLEON_1] =                 MSG_COLOR_BLACK,
