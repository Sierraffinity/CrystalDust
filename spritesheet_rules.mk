...
$(OBJEVENTGFXDIR)/people/emerald_brendan.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/emerald_may.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4


$(OBJEVENTGFXDIR)/people/team_rocket/rocket_grunt_f.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/team_rocket/rocket_grunt_m.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/people/reds_mom.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/pokemon/red_gyarados.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
...
$(OBJEVENTGFXDIR)/misc/book.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
...
$(OBJEVENTGFXDIR)/misc/ss_aqua.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 8 -mheight 4
...
$(FLDEFFGFXDIR)/long_grass_top_edge.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
